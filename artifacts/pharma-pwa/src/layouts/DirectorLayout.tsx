...
const navItems = [
  ...
  { to: '/director/bonus-fin/dashboard', label: 'المحفظة المالية', icon: Wallet, group: 'النمو' },
  { to: '/director/bonus-fin/ledger', label: 'دفتر البونص', icon: BookOpenText, group: 'النمو' },
  { to: '/director/bonus-fin/rules', label: 'القواعد المالية', icon: Layers, group: 'النمو' },
  { to: '/director/bonus-fin/redemptions', label: 'استرداد البونص', icon: PackageCheck, group: 'النمو' },
  { to: '/director/bonus-fin/withdrawals', label: 'سحب البونص', icon: Banknote, group: 'النمو' },
  { to: '/director/bonus-fin/pending', label: 'المعلقة', icon: Clock, group: 'النمو' },
  { to: '/director/bonus-fin/audit', label: 'تدقيق البونص', icon: FileSearch, group: 'النمو' },
  { to: '/director/bonus-fin/settings', label: 'إعدادات البونص', icon: Settings, group: 'النمو' },
